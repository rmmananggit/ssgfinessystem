...
<div class="container-fluid px-4">
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $row)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td> <a class="btn btn-info btn-sm" data-toggle="modal" data-target="#addfines"><i class="fa-sharp fa-solid fa-circle-plus"></i></a></td>
                                    </tr>
                                    <?php
                                }
                            }
  ...
  <!-- The Modal -->
  <div class="modal fade" id="addfines">
